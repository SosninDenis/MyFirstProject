...
class UserPhotoCollectionViewCell: UICollectionViewCell {
    ...
    private var changeNumberOfLikes:Int = -1
    ...
    // функция добавления количества лайков при нажании на сердечко
    @IBAction func tapOnButtonLike(_ sender: Any) {
        if (changeNumberOfLikes == -1) {
