...
class GropuListTableViewController: UITableViewController {

    
    var groupList = ["BMW Club", "Football", "Новости"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let name = groupList[indexPath.row]
...
private extension GropuListTableViewController {
